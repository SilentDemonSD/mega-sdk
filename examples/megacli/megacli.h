...
void exec_alerts_new(autocomplete::ACState& s);
void exec_alerts_old(autocomplete::ACState& s);
void exec_alerts_number(autocomplete::ACState& s);
void exec_alerts_notify(autocomplete::ACState& s);
void exec_alerts_seen(autocomplete::ACState& s);
